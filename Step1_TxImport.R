...
library(datapasta) #pastes copy/data into R from clipboard
...
targets <- read_tsv("studydesign.txt") #NOT SURE WHY THIS ISN'T WORKING...
targets <- read.delim("studydesign.txt")
??read_tsv
?read.delim
...
Txi_gene <- tximport(path, 
                     ...
                     #set above to FALSE for genes or TRUE for transcript
                     countsFromAbundance = "lengthScaledTPM",
                     ignoreTxVersion = TRUE)
